        ...
        return (
            <div id="page-top">
                ...
                <div className ="row">
                    ...
                    <div className = "col-lg-3 col-sm-3 mx-auto text-center">
                        <button className ="btn btn-light flame" id="button_flame" onClick={regAccountWorker}>
                            <img src="images/6.svg" className="img-flame" alt="Trabalhador"/>
                        </button>
                        <p className="texticon">Trabalhador</p>
                        <p className="text">Caso seja um Membro de uma Autoridade Competente</p>
                    </div>
